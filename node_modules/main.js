...
//var main=function(){
    ...
    */
    ...
    for(var i=0; i<options.n; i++){
        ...
        l[i]={exposure:40000*Math.random()+1000, alpha:options.alphL, b:options.bL, sigma:options.sigL, t:options.t, x0:options.bL}; //for CIR
        //w.push([1]);
    }
    var lgd=lgdCF;    
	...
	var mu=options.n*40000*options.alph*options.maxPD;//for cir
	var sigma=0;//mu/4;
	var optGauss={};
	optGauss.w=[1, 0, 0];
